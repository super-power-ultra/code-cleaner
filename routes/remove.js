        ...
        if (stats.isFile()) {
          ...
          if (path.extname(filename) == '.js') {
            fs.readFile(`${origin_dir_name}\\${filename}`, 'utf-8', (error, data) => {
              ...
              const temp = data.replace(pattern, '');
              const temp2 = temp.replace(pattern_online, '');
              ...
              const temp3 = temp2.replace(pattern_line, '');
              const temp4 = beautify(temp3, {
              ...
              fs.writeFile(`${result_dir_name}\\${filename}`, temp4, 'utf-8', () => {
